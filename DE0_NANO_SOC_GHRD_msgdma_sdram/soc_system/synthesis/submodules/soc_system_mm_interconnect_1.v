...
module soc_system_mm_interconnect_1 (
	...
	wire    [7:0] alt_vip_cl_vfb_0_mem_master_rd_translator_avalon_universal_master_0_burstcount;    // alt_vip_cl_vfb_0_mem_master_rd_translator:uav_burstcount -> alt_vip_cl_vfb_0_mem_master_rd_agent:av_burstcount
	...
	wire    [7:0] alt_vip_cl_vfb_0_mem_master_wr_translator_avalon_universal_master_0_burstcount;    // alt_vip_cl_vfb_0_mem_master_wr_translator:uav_burstcount -> alt_vip_cl_vfb_0_mem_master_wr_agent:av_burstcount
	wire          rsp_mux_002_src_valid;                                                             // rsp_mux_002:src_valid -> alt_vip_cl_vfb_0_mem_master_wr_agent:rp_valid
	wire  [118:0] rsp_mux_002_src_data;                                                              // rsp_mux_002:src_data -> alt_vip_cl_vfb_0_mem_master_wr_agent:rp_data
	wire          rsp_mux_002_src_ready;                                                             // alt_vip_cl_vfb_0_mem_master_wr_agent:rp_ready -> rsp_mux_002:src_ready
	wire    [2:0] rsp_mux_002_src_channel;                                                           // rsp_mux_002:src_channel -> alt_vip_cl_vfb_0_mem_master_wr_agent:rp_channel
	wire          rsp_mux_002_src_startofpacket;                                                     // rsp_mux_002:src_startofpacket -> alt_vip_cl_vfb_0_mem_master_wr_agent:rp_startofpacket
	wire          rsp_mux_002_src_endofpacket;                                                       // rsp_mux_002:src_endofpacket -> alt_vip_cl_vfb_0_mem_master_wr_agent:rp_endofpacket
	wire          hps_only_master_master_agent_cp_valid;                                             // hps_only_master_master_agent:cp_valid -> router:sink_valid
	wire  [118:0] hps_only_master_master_agent_cp_data;                                              // hps_only_master_master_agent:cp_data -> router:sink_data
	...
	wire  [118:0] alt_vip_cl_vfb_0_mem_master_rd_agent_cp_data;                                      // alt_vip_cl_vfb_0_mem_master_rd_agent:cp_data -> router_001:sink_data
	...
	wire          alt_vip_cl_vfb_0_mem_master_wr_agent_cp_valid;                                     // alt_vip_cl_vfb_0_mem_master_wr_agent:cp_valid -> router_002:sink_valid
	wire  [118:0] alt_vip_cl_vfb_0_mem_master_wr_agent_cp_data;                                      // alt_vip_cl_vfb_0_mem_master_wr_agent:cp_data -> router_002:sink_data
	wire          alt_vip_cl_vfb_0_mem_master_wr_agent_cp_ready;                                     // router_002:sink_ready -> alt_vip_cl_vfb_0_mem_master_wr_agent:cp_ready
	wire          alt_vip_cl_vfb_0_mem_master_wr_agent_cp_startofpacket;                             // alt_vip_cl_vfb_0_mem_master_wr_agent:cp_startofpacket -> router_002:sink_startofpacket
	wire          alt_vip_cl_vfb_0_mem_master_wr_agent_cp_endofpacket;                               // alt_vip_cl_vfb_0_mem_master_wr_agent:cp_endofpacket -> router_002:sink_endofpacket
	...
	wire  [118:0] hps_0_f2h_axi_slave_agent_write_rp_data;                                           // hps_0_f2h_axi_slave_agent:write_rp_data -> router_003:sink_data
	...
	wire  [118:0] hps_0_f2h_axi_slave_agent_read_rp_data;                                            // hps_0_f2h_axi_slave_agent:read_rp_data -> router_004:sink_data
	...
	wire  [118:0] router_src_data;                                                                   // router:src_data -> hps_only_master_master_limiter:cmd_sink_data
	wire          router_src_ready;                                                                  // hps_only_master_master_limiter:cmd_sink_ready -> router:src_ready
	wire    [2:0] router_src_channel;                                                                // router:src_channel -> hps_only_master_master_limiter:cmd_sink_channel
	...
	wire  [118:0] hps_only_master_master_limiter_cmd_src_data;                                       // hps_only_master_master_limiter:cmd_src_data -> cmd_demux:sink_data
	wire          hps_only_master_master_limiter_cmd_src_ready;                                      // cmd_demux:sink_ready -> hps_only_master_master_limiter:cmd_src_ready
	wire    [2:0] hps_only_master_master_limiter_cmd_src_channel;                                    // hps_only_master_master_limiter:cmd_src_channel -> cmd_demux:sink_channel
	...
	wire  [118:0] rsp_mux_src_data;                                                                  // rsp_mux:src_data -> hps_only_master_master_limiter:rsp_sink_data
	wire          rsp_mux_src_ready;                                                                 // hps_only_master_master_limiter:rsp_sink_ready -> rsp_mux:src_ready
	wire    [2:0] rsp_mux_src_channel;                                                               // rsp_mux:src_channel -> hps_only_master_master_limiter:rsp_sink_channel
	...
	wire  [118:0] hps_only_master_master_limiter_rsp_src_data;                                       // hps_only_master_master_limiter:rsp_src_data -> hps_only_master_master_agent:rp_data
	...
	wire  [118:0] router_001_src_data;                                                               // router_001:src_data -> alt_vip_cl_vfb_0_mem_master_rd_limiter:cmd_sink_data
	wire          router_001_src_ready;                                                              // alt_vip_cl_vfb_0_mem_master_rd_limiter:cmd_sink_ready -> router_001:src_ready
	wire    [2:0] router_001_src_channel;                                                            // router_001:src_channel -> alt_vip_cl_vfb_0_mem_master_rd_limiter:cmd_sink_channel
	...
	wire  [118:0] alt_vip_cl_vfb_0_mem_master_rd_limiter_cmd_src_data;                               // alt_vip_cl_vfb_0_mem_master_rd_limiter:cmd_src_data -> cmd_demux_001:sink_data
	wire          alt_vip_cl_vfb_0_mem_master_rd_limiter_cmd_src_ready;                              // cmd_demux_001:sink_ready -> alt_vip_cl_vfb_0_mem_master_rd_limiter:cmd_src_ready
	wire    [2:0] alt_vip_cl_vfb_0_mem_master_rd_limiter_cmd_src_channel;                            // alt_vip_cl_vfb_0_mem_master_rd_limiter:cmd_src_channel -> cmd_demux_001:sink_channel
	wire          alt_vip_cl_vfb_0_mem_master_rd_limiter_cmd_src_startofpacket;                      // alt_vip_cl_vfb_0_mem_master_rd_limiter:cmd_src_startofpacket -> cmd_demux_001:sink_startofpacket
	wire          alt_vip_cl_vfb_0_mem_master_rd_limiter_cmd_src_endofpacket;                        // alt_vip_cl_vfb_0_mem_master_rd_limiter:cmd_src_endofpacket -> cmd_demux_001:sink_endofpacket
	wire          rsp_mux_001_src_valid;                                                             // rsp_mux_001:src_valid -> alt_vip_cl_vfb_0_mem_master_rd_limiter:rsp_sink_valid
	wire  [118:0] rsp_mux_001_src_data;                                                              // rsp_mux_001:src_data -> alt_vip_cl_vfb_0_mem_master_rd_limiter:rsp_sink_data
	wire          rsp_mux_001_src_ready;                                                             // alt_vip_cl_vfb_0_mem_master_rd_limiter:rsp_sink_ready -> rsp_mux_001:src_ready
	wire    [2:0] rsp_mux_001_src_channel;                                                           // rsp_mux_001:src_channel -> alt_vip_cl_vfb_0_mem_master_rd_limiter:rsp_sink_channel
	wire          rsp_mux_001_src_startofpacket;                                                     // rsp_mux_001:src_startofpacket -> alt_vip_cl_vfb_0_mem_master_rd_limiter:rsp_sink_startofpacket
	wire          rsp_mux_001_src_endofpacket;                                                       // rsp_mux_001:src_endofpacket -> alt_vip_cl_vfb_0_mem_master_rd_limiter:rsp_sink_endofpacket
	...
	wire  [118:0] alt_vip_cl_vfb_0_mem_master_rd_limiter_rsp_src_data;                               // alt_vip_cl_vfb_0_mem_master_rd_limiter:rsp_src_data -> alt_vip_cl_vfb_0_mem_master_rd_agent:rp_data
	...
	wire    [2:0] alt_vip_cl_vfb_0_mem_master_rd_limiter_rsp_src_channel;                            // alt_vip_cl_vfb_0_mem_master_rd_limiter:rsp_src_channel -> alt_vip_cl_vfb_0_mem_master_rd_agent:rp_channel
	...
	wire  [118:0] cmd_mux_src_data;                                                                  // cmd_mux:src_data -> hps_0_f2h_axi_slave_wr_burst_adapter:sink0_data
	wire          cmd_mux_src_ready;                                                                 // hps_0_f2h_axi_slave_wr_burst_adapter:sink0_ready -> cmd_mux:src_ready
	wire    [2:0] cmd_mux_src_channel;                                                               // cmd_mux:src_channel -> hps_0_f2h_axi_slave_wr_burst_adapter:sink0_channel
	...
	wire  [118:0] hps_0_f2h_axi_slave_wr_burst_adapter_source0_data;                                 // hps_0_f2h_axi_slave_wr_burst_adapter:source0_data -> hps_0_f2h_axi_slave_agent:write_cp_data
	...
	wire  [118:0] cmd_mux_001_src_data;                                                              // cmd_mux_001:src_data -> hps_0_f2h_axi_slave_rd_burst_adapter:sink0_data
	wire          cmd_mux_001_src_ready;                                                             // hps_0_f2h_axi_slave_rd_burst_adapter:sink0_ready -> cmd_mux_001:src_ready
	wire    [2:0] cmd_mux_001_src_channel;                                                           // cmd_mux_001:src_channel -> hps_0_f2h_axi_slave_rd_burst_adapter:sink0_channel
	...
	wire  [118:0] hps_0_f2h_axi_slave_rd_burst_adapter_source0_data;                                 // hps_0_f2h_axi_slave_rd_burst_adapter:source0_data -> hps_0_f2h_axi_slave_agent:read_cp_data
	...
	wire  [118:0] cmd_demux_001_src1_data;                                                           // cmd_demux_001:src1_data -> cmd_mux_001:sink1_data
	...
	wire  [118:0] cmd_demux_002_src1_data;                                                           // cmd_demux_002:src1_data -> cmd_mux_001:sink2_data
	...
	wire  [118:0] rsp_demux_001_src1_data;                                                           // rsp_demux_001:src1_data -> rsp_mux_001:sink1_data
	...
	wire  [118:0] rsp_demux_001_src2_data;                                                           // rsp_demux_001:src2_data -> rsp_mux_002:sink1_data
	...
	wire  [118:0] cmd_demux_src0_data;                                                               // cmd_demux:src0_data -> crosser:in_data
	...
	wire  [118:0] crosser_out_data;                                                                  // crosser:out_data -> cmd_mux:sink0_data
	...
	wire  [118:0] cmd_demux_src1_data;                                                               // cmd_demux:src1_data -> crosser_001:in_data
	...
	wire  [118:0] crosser_001_out_data;                                                              // crosser_001:out_data -> cmd_mux_001:sink0_data
	...
	wire  [118:0] rsp_demux_src0_data;                                                               // rsp_demux:src0_data -> crosser_002:in_data
	...
	wire  [118:0] crosser_002_out_data;                                                              // crosser_002:out_data -> rsp_mux:sink0_data
	...
	wire  [118:0] rsp_demux_001_src0_data;                                                           // rsp_demux_001:src0_data -> crosser_003:in_data
	...
	wire  [118:0] crosser_003_out_data;                                                              // crosser_003:out_data -> rsp_mux:sink1_data
	...
	wire    [2:0] hps_only_master_master_limiter_cmd_valid_data;                                     // hps_only_master_master_limiter:cmd_src_valid -> cmd_demux:sink_valid
	wire    [2:0] alt_vip_cl_vfb_0_mem_master_rd_limiter_cmd_valid_data;                             // alt_vip_cl_vfb_0_mem_master_rd_limiter:cmd_src_valid -> cmd_demux_001:sink_valid
	...
	altera_avalon_st_handshake_clock_crosser #(
		...
		.in_reset          (hps_only_master_master_translator_reset_reset_bridge_in_reset_reset), //  in_clk_reset.reset
	...
	altera_avalon_st_handshake_clock_crosser #(
		...
		.out_reset         (hps_only_master_master_translator_reset_reset_bridge_in_reset_reset), // out_clk_reset.reset
