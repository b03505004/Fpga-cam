...
module soc_system_mm_interconnect_1 (
	...
	wire  [115:0] hps_only_master_master_agent_cp_data;                                      // hps_only_master_master_agent:cp_data -> router:sink_data
	...
	wire  [115:0] hps_0_f2h_axi_slave_agent_write_rp_data;                                   // hps_0_f2h_axi_slave_agent:write_rp_data -> router_001:sink_data
	...
	wire  [115:0] hps_0_f2h_axi_slave_agent_read_rp_data;                                    // hps_0_f2h_axi_slave_agent:read_rp_data -> router_002:sink_data
	...
	wire  [115:0] router_src_data;                                                           // router:src_data -> hps_only_master_master_limiter:cmd_sink_data
	...
	wire  [115:0] hps_only_master_master_limiter_cmd_src_data;                               // hps_only_master_master_limiter:cmd_src_data -> cmd_demux:sink_data
	...
	wire  [115:0] rsp_mux_src_data;                                                          // rsp_mux:src_data -> hps_only_master_master_limiter:rsp_sink_data
	...
	wire  [115:0] hps_only_master_master_limiter_rsp_src_data;                               // hps_only_master_master_limiter:rsp_src_data -> hps_only_master_master_agent:rp_data
	...
	wire  [115:0] cmd_demux_src1_data;                                                       // cmd_demux:src1_data -> crosser_001:in_data
	...
	wire  [115:0] crosser_001_out_data;                                                      // crosser_001:out_data -> cmd_mux_001:sink0_data
	...
	wire  [115:0] rsp_demux_src0_data;                                                       // rsp_demux:src0_data -> crosser_002:in_data
	...
	wire  [115:0] crosser_002_out_data;                                                      // crosser_002:out_data -> rsp_mux:sink0_data
	...
	wire  [115:0] rsp_demux_001_src0_data;                                                   // rsp_demux_001:src0_data -> crosser_003:in_data
	...
	wire  [115:0] crosser_003_out_data;                                                      // crosser_003:out_data -> rsp_mux:sink1_data
