...
module soc_system_alt_vip_cl_vfb_0 #(
		...
		parameter MEM_BASE_ADDR                = -268435456,
		parameter BURST_ALIGNMENT              = 0,
	...
	alt_vip_vfb_sync_ctrl #(
		...
		.CONTEXT_WIDTH            (8),
		.TASK_WIDTH               (8),
		.FRAME_BUFFER_LENGTH      (921600),
		.ANC_BUFFER_LENGTH        (12),
		.MAX_WIDTH                (640),
		.MAX_HEIGHT               (480),
		.NUM_BUFFERS              (3),
